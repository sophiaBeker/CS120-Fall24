...
1. With your partner, edit the `make_message.cc` and `make_message_functions.cc` source files using VS Code. Replace all the TODO comments with working code.
1. Compile your program with the `$ make` shell command. Use the **debug compile error** procedure to debug any compile errors.
1. Run your program with the `$ ./make_message` shell command.
