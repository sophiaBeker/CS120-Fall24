...
targets = 'spelling secret'.split()

lab = {
    # Due date for labs
    'mon_duedate': date(2024, 4, 24),
    'tues_duedate': date(2024, 4, 17),
    'wed_duedate': date(2024, 4, 17),
    'num_parts': 2,
...
global_makefile = {
    ...
    'darwin_GTESTLIBS': '-L /opt/local/libexec/llvm-18/lib/libc++ -L /opt/local/libexec/llvm-18/lib -L /opt/local/lib -lgtest -lgtest_main -lunwind -rpath /opt/local/libexec/llvm-18/lib/libc++ -rpath /opt/local/libexec/llvm-18/lib',
}
