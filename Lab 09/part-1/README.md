...
1. With your partner, edit the `spelling.cc` and `spelling_functions.cc` source files using VS Code. Add the required header. Replace all the TODO comments with working code.
...
when it is absent from the dictionary file.
