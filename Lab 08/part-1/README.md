...
1. With your partner, edit the `judge.cc` and `judge_functions.cc` source files using VS Code. Add the required header. Replace all the TODO comments with working code.
